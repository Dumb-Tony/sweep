...
const files=['index.html','model.js','scene.js','art.js','character.js','mouse-look.js','style.css','vendor/three.module.min.js','vendor/three.core.min.js','vendor/LICENSE'];
